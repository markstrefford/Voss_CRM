...
- 2026-06-23 Ranking test coverage: interactions/follow-ups have subject-vs-body tests but no FK-tertiary ranking test (deals do, via d_fk). Minor — add for symmetry if revisiting search tests. [e02-s02-search-ranking]
